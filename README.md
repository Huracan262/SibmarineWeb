...
## Развертывание нового приложения на основе boilerplate (Steroids фреймворк)

https://steroids.kozhindev.com/ru/docs
...
Шрифты хранятся в файле src/style/fonts.scss и подгружаются в src/style/global.scss
